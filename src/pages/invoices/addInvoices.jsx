      ...
      <div className="card form-card">
        <div className="card-header">
          <div className="card-header-items">
            ...
            <div>
              <button className="btn add-btn" onClick={() => navigateTo('/customers')}>
                {' '}
        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-md-4 mb-2">
              ...
              <input placeholder="Doctor's Name" type="text" className="form-control" />
            </div>
          </div>
          <div className="row">
            <div className="col-md-4 mb-2">
              <label className="form-label"> Customer's Name </label>
              <input placeholder="Customer's Name" type="text" className="form-control" />
            </div>
            <div className="col-md-4 mb-2">
              <label className="form-label">
                Contact No.
              ...
              <input placeholder="Contact No" type="number" className="form-control" />
            </div>
